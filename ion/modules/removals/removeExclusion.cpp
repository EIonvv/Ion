...
{
    string command = "powershell -Command Remove-MpPreference -ExclusionPath " + std::string(argv[2]);
...
{
    string command = "powershell -Command Remove-MpPreference -ExclusionExtension " + std::string(argv[2]);
